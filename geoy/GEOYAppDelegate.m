...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GEOYangcheModel" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"GEOYangcheModel.sqlite"];
//    
//    NSError *error = nil;
